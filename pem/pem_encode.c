...
static int	__des_crypt(t_ostring *content, t_ostring *cipher, const char *pass)
{
	t_des	*des;
	unsigned char	key[8];
...
static void	__concat(char *dst, size_t *dstsize, const char *src, size_t srcsize)
{
...
static int	__crypt_encode(t_ostring *content, char **pemenc, size_t *pemsize, const char *pass)
{
	t_ostring	cipher;
	char		*crypt_pemenc;
