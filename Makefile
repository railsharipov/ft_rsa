...
debug: CFLAGS := -Og -g -std=c11 -Wall -Wfatal-errors -Werror=switch -Werror=switch-enum -I./include -I./libs
debug: $(NAME)

sanitize: CFLAGS := -Og -g -std=c11 -Wall -Wfatal-errors -Werror=switch -Werror=switch-enum -fsanitize=address -fno-omit-frame-pointer -I./include -I./libs
