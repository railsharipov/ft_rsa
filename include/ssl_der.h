...
int		der_append_ostring(t_der *der, void *content, size_t dersize);
int		der_append_bitstring(t_der *der, void *content, size_t dersize);
int		der_append_oid(t_der *der, void *content, size_t dersize);
int		der_append_null(t_der *der, void *content, size_t dersize);
int		der_append_len(char *, size_t dersize);
