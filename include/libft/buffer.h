...
typedef int 	(*t_func_buffer_transform)(void *vctx, const void *src, size_t srcsize, void *dst, size_t dstsize, size_t *consumed, size_t *produced);
...
int 		ft_buffer_transform_read(t_buffer *buffer, t_func_buffer_transform transform, void *vctx, void *buf, size_t nbytes, size_t *consumed, size_t *produced);
int 		ft_buffer_transform_write(t_buffer *buffer, t_func_buffer_transform transform, void *vctx, const void *buf, size_t nbytes, size_t *consumed, size_t *produced);
