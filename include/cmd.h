...
int     cmd_base64(const char **opt, const char *name_comm);
int     cmd_hash(const char **opt, const char *name_comm);
int     cmd_des_ecb(const char **opt, const char *name_comm);
int     cmd_des_cbc(const char **opt, const char *name_comm);
int     cmd_rsa_gen(const char **opt, const char *name_comm);
int     cmd_rsa(const char **opt, const char *name_comm);
int     cmd_rsa_utl(const char **opt, const char *name);
int     cmd_test(const char **opt, const char *name);
