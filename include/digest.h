...
void	md5_update(t_hash *ctx, const unsigned char *buf, size_t bufsize);
...
void	sha1_update(t_hash *ctx, const unsigned char *buf, size_t bufsize);
...
void	sha256_update(t_hash *ctx, const unsigned char *buf, size_t bufsize);
...
void	sha224_update(t_hash *ctx, const unsigned char *buf, size_t bufsize);
...
void	sha512_update(t_hash *ctx, const unsigned char *buf, size_t bufsize);
...
void	sha384_update(t_hash *ctx, const unsigned char *buf, size_t bufsize);
void	sha384_final(t_hash *ctx);
