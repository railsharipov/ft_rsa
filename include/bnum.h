...
void	num_to_bytes_u(const t_num *, char **, size_t *);
...
void	add_dig(const t_num *, uint64_t, t_num *);
void	add_dig_u(const t_num *, uint64_t, t_num *);
void	sub_num(const t_num *, const t_num *, t_num *);
void	sub_num_u(const t_num *, const t_num *, t_num *);
void	sub_dig(const t_num *, uint64_t, t_num *);
void	sub_dig_u(const t_num *, uint64_t, t_num *);
...
void	mul_dig(const t_num *, uint64_t, t_num *);
...
void	divmod_dig(const t_num *, uint64_t, t_num *, uint64_t *);
